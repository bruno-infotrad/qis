...
elgg_make_sticky_form('manage_corporate_info');
...
$company_id_number = get_input('company_id_number');
$group->company_id_number = $company_id_number;
$company_registration_card_number = get_input('company_registration_card_number');
$group->company_registration_card_number = $company_registration_card_number;
...
elgg_clear_sticky_form('manage_corporate_info');
...
forward('qis/manage_corporate_info');
